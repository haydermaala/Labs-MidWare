...
public sealed class TenantExportTests
{
    ...
    [Fact]
    public void Build_Gathers_Tenant_Fleet_Config_And_Audit()
    {
        ...
        var export = TenantExporter.Build(store, At, tenant.Id)!;
    ...
    {
        var store = new InMemoryControlPlaneStore(TimeProvider.System);
        Assert.Null(TenantExporter.Build(store, At, "ten_ghost"));
    }
}
