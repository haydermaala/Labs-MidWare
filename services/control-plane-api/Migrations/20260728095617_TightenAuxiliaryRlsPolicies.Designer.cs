...
namespace ControlPlane.Api.Migrations
{
    ...
    [Migration("20260728095617_TightenAuxiliaryRlsPolicies")]
    partial class TightenAuxiliaryRlsPolicies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControlPlane.Api.BillingEventEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ControlPlane.Api.GatewayEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastCaptureAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("ControlPlane.Api.InvitationEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ControlPlane.Api.MembershipEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ControlPlane.Api.PlatformOffboardRequestEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("SubjectTenantId")
                        .IsRequired()
                        .HasColumnType("text");

                    b.HasKey("Id");

                    b.HasIndex("SubjectTenantId");

                    b.ToTable("platform_offboard_requests", (string)null);
                });

            modelBuilder.Entity("ControlPlane.Api.PlatformRoleAssignmentEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ControlPlane.Api.PlatformSecurityEventEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("platform_security_events", (string)null);
                });

            modelBuilder.Entity("ControlPlane.Api.PlatformSupportGrantEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ControlPlane.Api.TenantEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("CoolingOffUntil")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<bool>("Offboarded")
                        .HasColumnType("boolean");

                    b.Property<DateTimeOffset?>("OffboardingStartedAt")
                        .HasColumnType("timestamp with time zone");
