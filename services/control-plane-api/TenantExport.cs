...
/// <summary>A tenant's exported control-plane data.</summary>
...
/// <summary>Builds a <see cref="TenantExport"/> from the store's tenant-scoped reads.</summary>
public static class TenantExporter
{
    /// <summary>Gather the tenant's data, or null if the tenant is unknown.</summary>
    public static TenantExport? Build(IControlPlaneStore store, DateTimeOffset at, string tenantId)
    {
        ...
        return new TenantExport(tenant, gateways, configs, audit, at);
    }
}
